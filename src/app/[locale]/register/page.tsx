    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-950 relative overflow-hidden">
        ...
        <Card className="w-full max-w-md p-8 relative z-10 border-slate-800 bg-slate-900/80">
            <div className="text-center mb-8">
                ...
                <h1 className="text-2xl font-bold text-white mb-2">Rejoindre l'élite</h1>
                <p className="text-slate-400 text-sm">Créez votre compte pour accéder aux analyses.</p>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-slate-800 text-center">
                <p className="text-slate-500 text-xs">
                    Déjà membre ? <Link href="/login" className="text-blue-400 hover:text-blue-300 font-bold">Connexion</Link>
                </p>
